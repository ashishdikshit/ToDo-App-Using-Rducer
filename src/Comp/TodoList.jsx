...
const TodoList = ({ id, text, isChecked }) => {
  ...
  return (
    <li>
      <button
        className={`checkBtn btn btn-circle ${editFlag && "v-hide"}`}
        onClick={checkTodo}
      >
        <BiCheck />
      </button>
      ...
      <button
        className={`editBtn btn btn-circle ${
          (isChecked || editFlag) && "v-hide"
        }`}
        onClick={editFx}
      >
        <BiEdit />
      ...
      <button
        className={`trashBtn btn btn-circle ${editFlag && "v-hide"}`}
        onClick={deleteTodo}
      >
        <BiTrashAlt />
      </button>
